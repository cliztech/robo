        ...
        <div className="absolute top-2 right-2 z-50 flex gap-2">
          <button
            ...
            className={`p-2 rounded-lg flex items-center gap-2 ${
              viewMode === 'classic' ? 'bg-blue-600 text-white' : 'bg-zinc-700 text-zinc-300'
            }`}
          >
            <List size={16} />
            Classic
          ...
          <button
            ...
            className={`p-2 rounded-lg flex items-center gap-2 ${
              viewMode === 'modular' ? 'bg-blue-600 text-white' : 'bg-zinc-700 text-zinc-300'
            }`}
          >
            <LayoutGrid size={16} />
            Modular
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-zinc-900 border-b border-zinc-800">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => setViewMode('classic')}
            className={`p-2 rounded-lg flex items-center gap-2 ${
              viewMode === 'classic' ? 'bg-blue-600 text-white' : 'bg-zinc-700 text-zinc-300 hover:bg-zinc-600'
            }`}
          >
            <List size={16} />
            Classic
          ...
          <button
            onClick={() => setViewMode('modular')}
            className={`p-2 rounded-lg flex items-center gap-2 ${
              viewMode === 'modular' ? 'bg-blue-600 text-white' : 'bg-zinc-700 text-zinc-300 hover:bg-zinc-600'
            }`}
          >
            <LayoutGrid size={16} />
            Modular
