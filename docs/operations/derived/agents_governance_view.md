# AGENTS Governance Derived View

This is a lightweight index for `AGENTS.md` governance content.
Normative definitions are maintained in `docs/operations/agent_governance_canonical.md`.
...
- `AGENTS.md` may provide expanded role catalogs and examples.
- If this derived view and `AGENTS.md` diverge from canonical governance, canonical wins.
