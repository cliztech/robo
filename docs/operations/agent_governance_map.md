...
| --- | --- | --- |
| Routing (QA / Change / Proposal + BMAD command selection) | [`Canonical BMAD startup policy`](./agent_execution_commands.md#canonical-bmad-startup-policy-codexgeminijules) | Canonical BMAD startup policy and route-to-command matrix are maintained here. |
...
| Skill usage (skill catalog, triggers, execution boundaries) | [`Skills Registry`](../../SKILLS.md) | Skills are registered and constrained in one canonical registry. |
