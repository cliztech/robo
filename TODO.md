...
- Freshness pointer: use [`docs/exec-plans/active/2026-02-25-next-unfinished-phase-build.md`](docs/exec-plans/active/2026-02-25-next-unfinished-phase-build.md) as the active execution packet; current packet as-of `2026-03-04` against `sprint-status.yaml` reconciliation (`last_reconciled: 2026-03-03`).
