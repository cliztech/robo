...
- [x] Add per-action approval workflows and immutable audit trail export ([TI-039](docs/exec-plans/active/tracked-issues/TI-039.md)).
...
- [x] **[complete]** Add security smoke script (authN/authZ checks, lockout checks) ([TI-041](docs/exec-plans/active/tracked-issues/TI-041.md)) — owner: QA Engineer; target: 2026-03-07; dependency gates: TI-039 outputs unblock TI-041 privileged-action checks; TI-040 encrypted-field coverage feeds TI-041 authz tests; evidence: `artifacts/security/logs/ti-041-security-smoke.log`, `artifacts/security/reports/ti-041-smoke-matrix-report.md`, `artifacts/security/hashes/ti-041-smoke-output.sha256`.
- [ ] **[in-progress]** Add per-action approval workflows and immutable audit trail export ([TI-039](docs/exec-plans/active/tracked-issues/TI-039.md)) — owner: Security Architect; target: 2026-03-03; evidence: `artifacts/security/logs/ti-039-approval-enforcement.log`, `artifacts/security/reports/ti-039-immutable-audit-export.md`, `artifacts/security/audit_exports/<yyyy-mm-dd>/<batch_id>.sha256`.
- [ ] **[blocked]** Add config-at-rest encryption for high-risk fields in JSON configs ([TI-040](docs/exec-plans/active/tracked-issues/TI-040.md)) — owner: Security Engineer; target: 2026-03-05; implementation_status: in_progress; release_readiness_status: blocked (DEP-TI040-01..03 open); evidence: `artifacts/security/logs/ti-040-config-encryption.log`, `artifacts/security/reports/ti-040-high-risk-field-inventory.md`, `artifacts/security/hashes/ti-040-config-before-after.sha256`.
- [ ] **[blocked]** Add security smoke script (authN/authZ checks, lockout checks) ([TI-041](docs/exec-plans/active/tracked-issues/TI-041.md)) — owner: QA Engineer; target: 2026-03-07; implementation_status: complete; release_readiness_status: blocked (pending TI040-ART-LOG/TI040-ART-REPORT/TI040-ART-HASH); dependency gates: TI-039 outputs unblock TI-041 privileged-action checks; TI-040 encrypted-field coverage feeds TI-041 authz tests; evidence: `artifacts/security/logs/ti-041-security-smoke.log`, `artifacts/security/reports/ti-041-smoke-matrix-report.md`, `artifacts/security/hashes/ti-041-smoke-output.sha256`.
- [ ] **[backlog]** Add per-action approval workflows and immutable audit trail export ([TI-039](docs/exec-plans/active/tracked-issues/TI-039.md)) — owner: Security Architect; target: 2026-03-03; evidence: `artifacts/security/logs/ti-039-approval-enforcement.log`, `artifacts/security/reports/ti-039-immutable-audit-export.md`, `artifacts/security/audit_exports/<yyyy-mm-dd>/<batch_id>.sha256`.
- [ ] **[backlog]** Add config-at-rest encryption for high-risk fields in JSON configs ([TI-040](docs/exec-plans/active/tracked-issues/TI-040.md)) — owner: Security Engineer; target: 2026-03-05; evidence: `artifacts/security/logs/ti-040-config-encryption.log`, `artifacts/security/reports/ti-040-high-risk-field-inventory.md`, `artifacts/security/hashes/ti-040-config-before-after.sha256`.
- [ ] **[backlog]** Add security smoke script (authN/authZ checks, lockout checks) ([TI-041](docs/exec-plans/active/tracked-issues/TI-041.md)) — owner: QA Engineer; target: 2026-03-07; dependency gates: TI-039 outputs unblock TI-041 privileged-action checks; TI-040 encrypted-field coverage feeds TI-041 authz tests; evidence: `artifacts/security/logs/ti-041-security-smoke.log`, `artifacts/security/reports/ti-041-smoke-matrix-report.md`, `artifacts/security/hashes/ti-041-smoke-output.sha256`.
