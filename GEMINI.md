...
For repository bootstrap behavior, use the canonical BMAD startup policy in [`docs/operations/agent_execution_commands.md`](docs/operations/agent_execution_commands.mdcanonical-bmad-startup-policy-codexgeminijules). Do not duplicate or fork the startup snippet in this file.
