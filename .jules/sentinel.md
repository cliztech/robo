...
## 2024-05-25 - [Child Process Execution Refactoring]
**Vulnerability:** Usage of bash -lc with unsanitized string interpolation for child processes.
**Learning:** Using bash -lc with string interpolation for child processes bypasses Node.js argument escaping, allowing unintended execution if variables are improperly controlled.
**Prevention:** Always invoke executables directly using an array of arguments, entirely avoiding shell execution.
