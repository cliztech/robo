...
## 2026-05-26 - [Dynamic configuration in child process execution]
**Vulnerability:** child process execution used shell expansion for dynamic external configuration.
**Learning:** Using shell expansion with external inputs can lead to unintended execution if the input is manipulated.
**Prevention:** Use shlex.split() to convert string commands into argument lists and disable shell expansion.
